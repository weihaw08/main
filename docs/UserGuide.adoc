...
image::CustomRating.png[width="550"]
...
image::AddCustomRating.png[width="550"]
...
image::EditCustomRating.png[width="550"]

.A rating of 3.5 for exercise 7
image::EditAnotherCustomRating.png[width="550"]
...
image::RunRatingRemoved.png[width="550"]

.Rating in exercise 7 is also removed
image::BenchPressRatingRemoved.png[width="550"]
