...
image::CustomRating.png[width="600"]
...
image::AddCustomRating.png[width="600"]
...
image::EditCustomRating.png[width="600"]

.A rating of 3.5 for exercise 7
image::EditAnotherCustomRating.png[width="600"]
...
image::RunRatingRemoved.png[width="600"]

.Rating in exercise 7 is also removed
image::BenchPressRatingRemoved.png[width="600"]
