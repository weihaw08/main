...
public class ClearCommandTest {
    ...
    public void execute_nonEmptyAddressBook_success() {
        Model model = new ModelManager(getTypicalExerciseBook(), new UserPrefs(), getDefaultPropertyManager());
        Model expectedModel = new ModelManager(getTypicalExerciseBook(), new UserPrefs(), getDefaultPropertyManager());
